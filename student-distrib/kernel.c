...
void entry(unsigned long magic, unsigned long addr) {
    ...
    /*mods_start: start of filesystem address*/
    /*mods_end: end of filesystem address*/
    /*Things to work on: */
    ...
    /* Init the PIC */
    i8259_init();
    disable_irq(0);   /// disable system timer irq 0, for PIT we get rid of this and initialize
    ...
    paging_init();
    terminal_init();
    /*Should I initialize the IDT before
     *initializing PIC?
     *I guess so
     * Enable interrupts
...
// #endif
    ...
    /*How??????*/
     // clear();
    // int32_t ret_val = execute((uint8_t *)"shell");
    // if(ret_val == 256)
    // {
    ...
    // else
    // {
    //   printf("Execute returned with code %d", ret_val);
    // }
    //int32_t retval;
    //retval = execute((uint8_t *)"shell");
